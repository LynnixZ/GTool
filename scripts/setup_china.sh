...
# Tsinghua PyPI 'torch' -- it resolves to the latest cu13 build and fails on a 12.x driver.
# GTool targets torch 2.2.2+cu121 (a common version SJTU carries; 2.1.0 was removed from all
