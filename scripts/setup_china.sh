...
# wheels (same driver-safe cu121 build, fast from China). DO NOT use plain Tsinghua
# PyPI 'torch' -- it resolves to the latest cu13 build and fails on a 12.x driver.
